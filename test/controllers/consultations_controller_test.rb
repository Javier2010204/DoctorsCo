...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post consultations_url, params: { consultation: { annotations: @consultation.annotations, date: @consultation.date, diagnosis: @consultation.diagnosis, patient_id: @consultation.patient_id, place: @consultation.place, subject: @consultation.subject, type: @consultation.type } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { annotations: @consultation.annotations, date: @consultation.date, diagnosis: @consultation.diagnosis, patient_id: @consultation.patient_id, place: @consultation.place, subject: @consultation.subject, type: @consultation.type } }
