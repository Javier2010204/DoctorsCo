...
class MedicalHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_history" do
    assert_difference('MedicalHistory.count') do
      post medical_histories_url, params: { medical_history: { allergies: @medical_history.allergies, diseases: @medical_history.diseases, medicine: @medical_history.medicine, patient_id: @medical_history.patient_id, size: @medical_history.size, user_id: @medical_history.user_id, weight: @medical_history.weight } }
    end
  ...
  test "should update medical_history" do
    patch medical_history_url(@medical_history), params: { medical_history: { allergies: @medical_history.allergies, diseases: @medical_history.diseases, medicine: @medical_history.medicine, patient_id: @medical_history.patient_id, size: @medical_history.size, user_id: @medical_history.user_id, weight: @medical_history.weight } }
