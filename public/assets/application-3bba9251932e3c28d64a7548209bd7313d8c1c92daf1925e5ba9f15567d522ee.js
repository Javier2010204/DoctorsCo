...
(function() {
  $(document).on("ajax:beforeSend", "#emails-form", function() {
    return $("#email-info").html("Estamos procesando tu peticion ...");
  });
  ...
  $(document).on("ajax:success", "#emails-form", function(e, data, estado, xhr) {
    ...
    $("#phone").val("");
    $("#address").val("");
    return $("#email-info").html("Gracias por ayudarnos a revolucionar las consultas médicas");
  });
  ...
  $(document).on("ajax:error", "#emails-form", function(e, data, estado, xhr) {
    ...
    $("#email-info").slideDown("normal");
    $("#email-info").removeClass("hidden");
    return $("#email-info").html("no pudimos enviar tu correo, intentalo de nuevo");
  });
...
(function() {
  $(".close-parent").on("click", function(ev) {
    return $(this).patent().slideUp();
  });

  $("#sobre-nosotros-click").on("click", function(ev) {
    return console.log("scroooool");
  });
